...
class Chromosome:
    def __init__(self, bounds, NPC_size, time_size):
        ...
        self.timeoutTime = 30 # in seconds, timeout timer for simulator execution per each scenario simulation
    ...
    def decoding(self):
        ...
        for x in range(0, 100):
            ...
            os.system("python surrogate_simulation.py ./scenario.obj ./result.obj")
            resultObj = None

...
for i in train_file:
    ...
    train_dataset = loadDataset(
        ...
        target=["predict_NPC_speed","predict_NPC_location_X","predict_NPC_location_Y","predict_NPC_location_Z","predict_AV_speed","predict_AV_location_X","predict_AV_location_Y",
                "predict_AV_location_Z" ,"predict_NPC_Angle_X","predict_NPC_Angle_Y","predict_NPC_Angle_Z","predict_AV_Angle_X","predict_AV_Angle_Y","predict_AV_Angle_Z"],

...
for i in range(1000):
    datas = []
    with open("./dataset/trial"+str(i)+".csv",newline='') as trials:
    ...
    with open("./post_dataset/trial"+str(i)+".csv", 'w', newline='') as post_trials:
        ...
        while x < 36:
            ...
            #print(npc_angle)
            npc_angle_x = angle_fix_x(float(npc_angle[0]))
            npc_angle_y = float(npc_angle[1])/angle_y_div
            npc_angle_z = float(npc_angle[2])/angle_z_div
            ...
            av_angle_x = angle_fix_x(float(av_angle[0]))
            av_angle_y = float(av_angle[1])/angle_y_div
            av_angle_z = float(av_angle[2])/angle_z_div
            ...
            predicted_npc_angle_x = angle_fix_x(float(predicted_npc_angle[0]))
            predicted_npc_angle_y = float(predicted_npc_angle[1])/angle_y_div
            predicted_npc_angle_z = float(predicted_npc_angle[2])/angle_z_div
            ...
            predicted_AV_angle_x = angle_fix_x(float(predicted_AV_angle[0]))
            predicted_AV_angle_y = float(predicted_AV_angle[1])/angle_y_div
            predicted_AV_angle_z = float(predicted_AV_angle[2])/angle_z_div

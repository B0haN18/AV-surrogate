...
class lstm_seq2seq(nn.Module):
            ...
            for it in tr:
                ...
                for dataloader in dataloader_l:
                    ...
                    for b in range(n_batches):
                        ...
                        target_batch_npc = target_tensor[:, b: b + batch_size, 0:7]
                        #print(target_batch_npc)
                        target_batch_av = target_tensor[:, b: b + batch_size, 7:14]
    ...
    def predict(self, input_tensor, target_len):
        ...
        output_fc_npc = torch.zeros(target_len,  7)
        output_fc_av = torch.zeros(target_len,  7)
